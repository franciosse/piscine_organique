    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PrincipesPage.useEffect": ()=>{
                    ...
                    entries.forEach({
                        "PrincipesPage.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                setVisibleSections({
                                    "PrincipesPage.useEffect": (prev)=>new Set([
                                            ...prev,
                                            entry.target.id
                                        ])
                                }["PrincipesPage.useEffect"]);
            ...
            document.querySelectorAll('[data-section]').forEach({
                "PrincipesPage.useEffect": (el)=>observer.observe(el)
            }["PrincipesPage.useEffect"]);
            return ({
...
_s(PrincipesPage, "ceIwMFzqGxiu6PqfpSOFHqxvnb8=");
_c = PrincipesPage;
var _c;
...
//# sourceMappingURL=_70cc8e3d._.js.map